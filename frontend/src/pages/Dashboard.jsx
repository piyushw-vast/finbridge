...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white dark:bg-slate-800 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center">
            <span className="text-white font-bold text-sm">F</span>
          </div>
          <span className="font-semibold text-gray-900 dark:text-white">FinBridge</span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-xl font-semibold text-gray-900 dark:text-white mt-1">{roleLabels[user?.role]}</p>
          </div>
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 p-6">
