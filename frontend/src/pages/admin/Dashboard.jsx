    ...
    <Layout>
      <div className="px-8 py-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 shadow-sm p-5 text-center">
        ...
        <h2 className="text-base font-semibold text-slate-900 dark:text-white mb-4">Accounting Firms</h2>
        {loading ? (
          ...
          <div className="text-center py-16 bg-white dark:bg-slate-800 rounded-2xl border border-dashed border-slate-200">
            <p className="text-slate-700 dark:text-slate-200 font-semibold">No firms onboarded yet</p>
          </div>
        ) : (
              ...
              <tbody className="divide-y divide-slate-50">
                {firms.map(f => (
                  <tr key={f.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-5 py-4 font-semibold text-slate-800 dark:text-slate-100">{f.name}</td>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto shadow-xl">
            <div className="flex items-center justify-between px-6 pt-6 pb-4 sticky top-0 bg-white dark:bg-slate-800 rounded-t-2xl border-b border-slate-100">
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Onboard Accounting Firm</h2>
